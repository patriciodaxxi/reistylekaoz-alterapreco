...
begin
  ...
  begin
     ...
     dmod.Qry.edit;
     if rdgTipoAjuste.ItemIndex = 0 then
     begin
...
procedure TdrmPrincipal.ajustarpreco;
...
begin
  ...
  begin
     ...
     if rdgTipoAjuste.ItemIndex = 0 then
     begin
       dmod.Qry.FieldValues['VALOR_PRO'] := dmod.Qry.FieldValues['VALOR_PRO'] + edtPerc.Text;
     end
     else
     begin
       dmod.Qry.FieldValues['VALOR_PRO'] := dmod.Qry.FieldValues['VALOR_PRO'] - edtPerc.Text;
